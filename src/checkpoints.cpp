...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 0,     std::make_pair(hashGenesisBlock, 1470257730) )
    //    ( 1, std::make_pair(uint256("0x000000835f86ea2363c4c77d598e193db352c8045305d39012b806ef8c6d0b26"), 1464087166) )
    ;

    // TestNet has no checkpoints
    static MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        ( 0, std::make_pair(hashGenesisBlockTestNet, 1470257731) )
        ;
