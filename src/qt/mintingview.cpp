...
{
	setStyleSheet("background:rgb(52,52,52);");
	...
	youngLegend->setStyleSheet("color:rgb(238,229,233);");
	...
	matureLegend->setStyleSheet("color:rgb(238,229,233);");
	...
	oldLegend->setStyleSheet("color:rgb(238,229,233);");
	...
	mintingLabel->setStyleSheet("color:rgb(238,229,233);");
	...
	mintingCombo->setStyleSheet("color:rgb(238,229,233);");
	...
	view->setStyleSheet("background-color:rgb(52,52,52);color:rgb(0,0,0);");
