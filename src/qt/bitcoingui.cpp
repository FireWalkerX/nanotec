    ...
    optionsDialog(0)
{
    ...
    qApp->setStyleSheet("QMainWindow { background:rgb(52,52,52); color:rgb(238,229,233);font-family:'Proxima Nova Rg'; } #toolbar2 { border:none;width:28px; background:rgb(78,88,100); }");
#ifndef Q_OS_MAC
	...
	//statusBar()->setStyleSheet("background:rgb(107,109,118)");
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction->setStatusTip(tr("Show information about Nanotec"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nanotec"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nanotec addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nanotec addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your Nanotec addresses"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("#toolbar { font-weight:600;border:none;height:100%;padding-top:20px; background: rgb(78,88,100); text-align: left; color: white;min-width:180px;max-width:180px;} QToolBar QToolButton:hover {background:rgb(28,29,33);} QToolBar QToolButton:checked {background:rgba(28,29,33,100);}  QToolBar QToolButton { font-weight:600;font-size:10px;font-family:'Century Gothic';padding-left:20px;padding-right:181px;padding-top:5px;padding-bottom:5px; width:100%; color: white; text-align: left; text-transform:uppercase; }");
