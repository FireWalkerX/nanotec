...
static const int LADDER_LEVELS = 10; 
static const int64_t LADDER_THRESHOLDS[LADDER_LEVELS] = {
			    // monthly%  equiv_yearly%
    0,			// 0.5       6%
    1000,		// 0.75      9%
    5000,		// 1         12%
    15000,		// 1.5       18%
...
static const uint256 hashGenesisBlock("0x000003a21369b16867cb2190a3ba66275cb36be665a98931cc5f48379f937cd7");
static const uint256 hashGenesisBlockTestNet("0x00000600a2d784c6bd5e51d1e107d0f5704ffe5c072afbadf2bd4e5e6c3499bf");
...
int64_t GetLadderReward(int64_t nCoinValue, int64_t nHeight);
...
public:
    ...
    {
        // Protocol switch to support p2pool at Nanotec block #0
        if (true)
        {
        ...
        // Before Nanotec block #0 - get from pregenerated table
