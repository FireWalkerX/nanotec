...
{
    return GetBoolArg("-testnet", false) ? 18192 : 8192;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop Nanotec server (and possibly override the detachdb config value).");
...
void ThreadRPCServer2(void* parg)
{
    ...
    boost::signals2::signal<void ()> StNNCequests;
    ...
    try
    {
        ...
        StNNCequests.connect(signals2::slot<void ()>(
