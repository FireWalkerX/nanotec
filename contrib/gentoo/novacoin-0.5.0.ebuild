...
DESCRIPTION="Nanotec - a hybrid PoW+PoS energy efficient p2p-cryptocurrency and electronic payment system."
...
src_install() {
	...
	newins "src/qt/res/icons/Nanotec-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "Nanotec" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/Nanotec-qt.protocol ${PN}.protocol
	fi
}
